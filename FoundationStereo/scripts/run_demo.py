...
def get_depth_estimator():
  ...
  model.eval()
  return model
def get_depth(model,args, img0, img1):
...
# if __name__=="__main__":
  ...
  #   print(depth)
  #   print(depth.shape)
  #   print(np.min(depth, axis=0), np.max(depth,axis=0))
...
#python scripts/run_demo.py --left_file ./assets/left_762.jpg --right_file ./assets/right_762.jpg --ckpt_dir ./checkpoints/model_best_bp2.pth --out_dir ./test_outputs/


#python FoundationStereo/scripts/run_demo.py --left_file FoundationStereo/assets/left_762.jpg --right_file FoundationStereo/assets/right_762.jpg --ckpt_dir FoundationStereo/checkpoints/model_best_bp2.pth --out_dir FoundationStereo/test_outputs/